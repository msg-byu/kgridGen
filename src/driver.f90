PROGRAM kpoint_driver
  ...
  ! Normal tests
  call pysave(K, "../tests/tetragonal/K.in.2")
  call pysave(R, "../tests/tetragonal/R.in.2")
  call pysave(shift, "../tests/tetragonal/shift.in.2")
  call pysave(klist, "../tests/tetragonal/unreduced_klist.in.2")
  call pysave(pgOps, "../tests/tetragonal/symops.in.2")  
  call symmetryReduceKpointList(K, R, shift,  klist, pgOps, rdKlist, weights, eps)
  call pysave(rdKlist, "../tests/tetragonal/tetragonal_kpts.out.2")
  call pysave(weights, "../tests/tetragonal/tetragonal_wts.out.2")
